...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 30 juin 2022 à 16:42
...
--
CREATE DATABASE IF NOT EXISTS `menuiz2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `menuiz2`;
...
DROP TABLE IF EXISTS `t_d_savdetails_svl`;
...
DROP TABLE IF EXISTS `t_d_savfile_svf`;
...
(1, 'akaka', '2022-06-28 10:45:28', NULL, 3, 2, 1, 4, 4, '6'),
(2, 'akaka', '2022-07-12 14:18:50', NULL, 4, 3, 3, 4, 4, '7'),
(3, NULL, '0000-00-00 00:00:00', NULL, 3, 5, 1, NULL, NULL, NULL),
(4, NULL, '0000-00-00 00:00:00', NULL, 4, 5, 1, NULL, NULL, NULL),
(5, NULL, '2022-06-17 00:00:00', NULL, 4, 4, 1, NULL, NULL, NULL),
(8, NULL, '2022-09-28 15:21:00', NULL, 4, 10, 1, NULL, NULL, NULL);
...
DROP TABLE IF EXISTS `t_d_stockmovement_smt`;
...
(13, NULL, 'ara@ara.fr', 'ee12558b79a93418c5742c7d2ba3d51c15b94fee', 'ara', 'ara', 2),
...
--
ALTER TABLE `t_d_savfile_svf`
  MODIFY `SVF_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
